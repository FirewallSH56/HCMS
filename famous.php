	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul id="menu-principal" class="navbar-nav mr-auto">
			...
			<li class="menu-item menu-item-type-post_type_archive nav-item active">
				<a href="/famous" class="nav-link active">Salon de la fama</a>
			</li>
			<li class="menu-item menu-item-type-post_type_archive nav-item">
...
while($ocult = mysql_fetch_array($oculte)){ ?>
	<div class="alert alert-warning" role="alert"><b><?php echo $myrow['username']; ?></b>, 
no aparecerá en esta página porque ha configurado su cuenta para que esté <b>oculta</b>! <a href="/account/prefer">Haga clic aquí para cambiarlo</a>.</div>
<?php } ?>
		...
		<div class="card">
			<div class="card-body p-md-5">
				<div class="row">
					<div class="col-md-4">
						<h3>Ricos en Diamantes</h3>
						<br><br><br>
						<div class="text-muted mb-4 mb-md-0">Esta categoría muestra solo los <b>Cinco</b> Usuarios más ricos de diamantes en <?php echo $Holo['name']; ?> Hotel.</div>
					</div>
...
?>
		...
		<div class="card">
			<div class="card-body p-md-5">
				<div class="row">
					<div class="col-md-4">
						<h3>Ricos en Duckets</h3>
						<br><br><br>
						<div class="text-muted mb-4 mb-md-0">Esta categoría muestra solo los <b>Cinco</b> Usuarios más ricos de Duckets en <?php echo $Holo['name']; ?> Hotel.</div>
					</div>
					<div class="col-md-6 offset-md-2">
...
?>
		...
		<div class="card">
			<div class="card-body p-md-5">
				<div class="row">
					<div class="col-md-4">
						<h3>Ricos en Creditos</h3>
						<br><br><br>
						<div class="text-muted mb-4 mb-md-0">Esta categoría muestra solo los <b>Cinco</b> Usuarios más ricos de Creditos en <?php echo $Holo['name']; ?> Hotel.</div>
					</div>
					<div class="col-md-6 offset-md-2">
							...
							<div class="mb-3 topic-124">
								<div class="d-flex align-items-center">
									...
									<div class="w-100 d-md-flex align-items-center">
										...
										<small class="text-muted ml-md-2 mt-1"><strong><font color="#FF9030"><?php echo $user['credits']; ?> Creditos</font></strong></small>
									</div>
								</div>
							</div>
<?php } ?>
