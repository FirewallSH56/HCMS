...
<body class="home page-template-default" onselectstart='return false' ondragstart='return false'>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<?php $old = mysql_query("SELECT * FROM users WHERE id = '".$myrow['id']."' AND old = '1'");
        while($olds = mysql_fetch_assoc($old)){ ?><script>alert('¡Hola!, Hemos detectado que tienes que cambiar tu contraseña, dale en aceptar para continuar'),window.location.href = "/account/contra";</script><?php } ?>
					...
					<div class="carousel-item active">
						<img src="<?php echo $Holo['thumbsurl']; ?><?php echo $sql_n_u['id']; ?>.png" style="background-image: url(<?php echo $Holo['url']; ?>/Mawu/image/default_room.png);">
							<div class="carousel-caption">
								...
								<div>Creada por <a href="/home/<?php echo $user['username']; ?>"><font color="white"><?php echo mysql_real_escape_string(mb_strimwidth($user['username'], 0, 16, "...")); ?></font></a></div>
					...
					<div class="carousel-item">
						<img src="<?php echo $Holo['thumbsurl']; ?><?php echo $n_info['id']; ?>.png" style="background-image: url(<?php echo $Holo['url']; ?>/Mawu/image/default_room.png);">
							<div class="carousel-caption">
								...
								<div>Creada por <a href="/home/<?php echo $user2['username']; ?>"><font color="white"><?php echo mysql_real_escape_string(mb_strimwidth($user2['username'], 0, 16, "...")); ?></font></a></div>
