...
<div class="jumbotron jumbotron-fluid news cover">
		...
		<div class="container text-center">
			...
			<div class="infos">
				<div class="mx-3 mt-3">
					<a href="/home/<?php echo $myrow['username']; ?>" class="d-flex align-items-center">
						<div class="avatar pixel sm mr-2">
							<img src="<?php echo $Holo['avatar'] . $myrow['look']; ?>&amp;action=std&amp;direction=2&amp;head_direction=2&amp;img_format=png&amp;gesture=std&amp;headonly=0&amp;size=s" alt="">
						</div>

						<span data-toggle="tooltip" title="" data-original-title="<?php echo $user_n['username']; ?>"><?php echo $myrow['username']; ?></span>
					</a>
				</div>
