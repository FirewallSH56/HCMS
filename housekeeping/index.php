                ...
                <div class="kt-login__container">
                    <div class="kt-login__signin">
                        <div class="kt-login__head">
                            <h3 class="kt-login__title">Accede a nuestro panel de control</h3>
                        </div>
                        <form class="kt-form" action="" method="post">
                            <?php echo $msg; ?>
                            <div class="input-group loginform">
                                <input type="text" name='HUsername' class="form-control" placeholder="Tu usuario" required>
                            </div>
                            <div class="input-group loginform">
                                <input type="password" name='HPassword' class="form-control" placeholder="Tu contraseña" required>
                            </div>
							<div class="input-group loginform">
                                <input type="password" name='HPasscode' class="form-control" placeholder="Tu codigo de seguridad" required>
                            </div>
                            <div class="kt-login__actions">
                                <button id="kt_login_signin_submit" class="btn btn-success btn-elevate kt-login__btn-primary">Entrar</button>
                            </div>
                            <div class="kt-login__account">
                                <span class="kt-login__account-msg">¿Crees que no deberías estar aquí?</span>
                                <a href="<?php echo $Holo['url']; ?>/" id="kt_login_signup" class="kt-login__account-link">Volver al inicio</a>
                            </div>
                        </form>
                    </div>
                </div>
