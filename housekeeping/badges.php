...
mysql_query("INSERT INTO cms_hklogs SET type = 'Emblemas', note = 'Placa agregada: $titulo', author_name = '". $myrow['username'] ."', author_id = '". $myrow['id'] ."', author_rank = '". $myrow['rank'] ."', timestamp = '". time() ."'");
}
...
for ($i = 0; $i < $numeroCampos; $i++) {
	...
	if (!empty($nomeArquivo)) {
		...
		if (!$erro) {
			...
			mysql_query("INSERT INTO cms_hklogs SET type = 'Emblemas', note = 'Agregó la imagen a la placa: $nomeArquivo', author_name = '". $myrow['username'] ."', author_id = '". $myrow['id'] ."', author_rank = '". $myrow['rank'] ."', timestamp = '". time() ."'");
		} 
