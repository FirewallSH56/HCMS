...
<body class="home page-template-default" onselectstart='return false' ondragstart='return false'>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<a onclick="goBack()" class="btn btn-danger"><font color="white">Volver</font></a>    
...
<section>
	<div class="container">
	<div class="section-title"><h3>Existen <b><?php echo mysql_num_rows(mysql_query("SELECT * FROM cms_news WHERE category = 'promocao'")) ?></b> noticias en esta categoria</h3></div>
		<div class="row">
...
?>
	...
	<div class="cat <?php echo $new['category']; ?>" data-toggle="tooltip" data-html="true" title="" data-original-title="Cosas gratis">Cosas gratis</div></a>
<?php } ?>
...
?>
	<a href="/news/<?php echo $new['id']; ?>" class="cover"><img src="<?php echo $new['image']; ?>">
	<div class="cat <?php echo $new['category']; ?>" data-toggle="tooltip" data-html="true" title="" data-original-title="Promociones">Promociones</div></a>
<?php } ?>
