...
<img src="https://beeimg.com/images/u03956165841.gif" style="
    position: absolute;
	left: 30%;
">
		<div class="row">
	...
	<div class="text-center"> 
		<h4 class="mb-4">MANTENIMIENTO</h4>
		<p class="text-muted mb-0">Tranquilo, esto es temporal, tuvimos que cerrar temporalmente nuestro hotel para hacer algunos ajustes y mejorar el juego.</p>
		<hr>
		<p class="text-muted mb-0"><strong><?php echo $mantenimientoo['motivo']; ?></strong></p>
	</div>
