...
<section>
	<div class="container">
	<div class="section-title"><h3>Existen <b><?php echo mysql_num_rows(mysql_query("SELECT * FROM cms_news WHERE category = 'sistema'")) ?></b> noticias en esta categoria</h3></div>
		<div class="row">
