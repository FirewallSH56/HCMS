...
<div class="jumbotron jumbotron-fluid pink">
	<div class="container d-flex align-items-center">
		<h1>Galeria</h1> <a href="/hotel" class="btn btn-success ml-4">Únete al hotel y usa la cámara</a>
	</div>
</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-3 pr-md-3 mb-4">
				...
				<div class="tags grey">
					<small>Las últimas <b>45</b> fotos tomadas y publicadas dentro del Hotel, aparecerán en esta página, incluidas las tuyas..</small>
				</div>

				<h5 class="mb-3 mt-5">Fotos aleatorias</h5>
...
?>
	<div class="card gallery gallery-<?php echo $photo['id']; ?>">
		<a href="/photos/<?php echo $photo['id']; ?>" data-toggle="tooltip" title="" data-original-title="Foto por <?php echo $authorinfo['username']; ?>">
		<div class="cover">
			...
			<div class="infos">
				<h5 class="mb-3">Foto por <?php echo $authorinfo['username']; ?></h5>
