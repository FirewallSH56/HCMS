...
<head>
	...
	<title><?php echo $Holo['name']; ?>: Foto por <?php echo $user_n['username']; ?></title>
				...
				<div class="d-flex">
					...
					<div class="w-100 d-flex flex-column flex-md-row">
						<div class="w-100">
							...
							<div class="text-muted">Publicada hace <?php echo GetLast($photo5); ?></strong></div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-12 pl-md-3">
						<div class="galery-infos">
								<div><i class="fas fa-calendar fa-fw mr-2"></i>hace <?php echo GetLast($photo5); ?></div>
								<div class="mb-2"><i class="fas fa-eye fa-fw mr-2"></i> Foto tomada en la sala de <a href="/home/<?php echo $roomowner_n['username']; ?>"><span data-toggle="tooltip" title="" data-original-title="<?php echo $roomowner_n['username']; ?>"><?php echo $roomowner_n['username']; ?></span></a></div>
						</div>
						
						<hr>
						
	<h6 class="mb-3"><a class="text-inherit" href="/home/<?php echo $user_n['username']; ?>">Mas de <span data-toggle="tooltip" title="" data-original-title="<?php echo $user_n['username']; ?>"><?php echo $user_n['username']; ?></span></a></h6>
